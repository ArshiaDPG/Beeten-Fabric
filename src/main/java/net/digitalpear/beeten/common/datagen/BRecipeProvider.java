...
public class BRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        offerReversibleCompactingRecipes(withConditions(recipeExporter, ResourceConditions.allModsLoaded(ModCompat.FD_ID)), RecipeCategory.FOOD, BItems.HEART_BEET, RecipeCategory.BUILDING_BLOCKS, BBlocks.HEART_BEET_CRATE);
